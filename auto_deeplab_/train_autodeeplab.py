...
from auto_deeplab_.dataloaders import make_data_loader
from auto_deeplab_.auto_deeplab import AutoDeeplab
from auto_deeplab_.architect import Architect
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_loader1, self.train_loader2, self.val_loader, self.test_loader, self.nclass = \
