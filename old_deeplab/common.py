...
flags.DEFINE_string('model_variant', 'mobilenet_v2',
                  'DeepLab model variant [xception_65, mobilenet_v2].')
...
flags.DEFINE_string('merge_method', 'max', 'Scheme to merge multi scale features. [max, avg]')
