...
- [setup](#setup_)
   - [virtualenv       @ setup](#virtualenv___setu_p_)
   - [tf       @ setup](#tf___setu_p_)
- [256](#256_)
...
<a id="virtualenv___setu_p_"></a>
## virtualenv       @ setup-->deeplab
mkvirtualenv -p python3.7 ndl
alias ndl='workon ndl'

<a id="tf___setu_p_"></a>
## tf       @ setup-->deeplab
python -m pip install distutils
python -m pip install tensorflow_gpu==1.13.1

python -m pip install --upgrade https://storage.googleapis.com/tensorflow/linux/gpu/tensorflow_gpu-1.6.0-cp38-cp38m-linux_x86_64.whl
python -m pip install --upgrade https://storage.googleapis.com/tensorflow/linux/gpu/tensorflow_gpu-1.6.0-cp27-none-linux_x86_64.whl
...
### output_stride_16       @ 50/256-->deeplab
...
#### eval       @ output_stride_16/50/256-->deeplab
...
#### vis       @ output_stride_16/50/256-->deeplab
...
#### validation       @ output_stride_16/50/256-->deeplab
...
#### stitching       @ output_stride_16/50/256-->deeplab
...
### output_stride_8       @ 50/256-->deeplab
...
#### eval       @ output_stride_8/50/256-->deeplab
...
#### vis       @ output_stride_8/50/256-->deeplab
...
#### validation       @ output_stride_8/50/256-->deeplab
...
#### eval       @ batch_size_6/50/384-->deeplab
...
#### vis       @ batch_size_6/50/384-->deeplab
...
#### validation       @ batch_size_6/50/384-->deeplab
...
#### eval       @ batch_size_8/50/384-->deeplab
...
#### vis       @ batch_size_8/50/384-->deeplab
...
#### eval       @ batch_size_6/50/512-->deeplab
...
#### vis       @ batch_size_6/50/512-->deeplab
...
#### validation       @ batch_size_6/50/512-->deeplab
...
#### vis       @ batch_size_2/50/512-->deeplab
...
#### validation       @ batch_size_2/50/512-->deeplab
...
## build_data       @ 640-->deeplab

<a id="0_3___build_data_640_"></a>
### 0_3       @ build_data/640-->deeplab
...
### 0_3_non_aug       @ build_data/640-->deeplab

<a id="all___0_3_non_aug_build_data_640_"></a>
#### all       @ 0_3_non_aug/build_data/640-->deeplab
...
#### sel_2       @ 0_3_non_aug/build_data/640-->deeplab
...
#### sel_10       @ 0_3_non_aug/build_data/640-->deeplab
...
#### sel_100       @ 0_3_non_aug/build_data/640-->deeplab
...
#### sel_1000       @ 0_3_non_aug/build_data/640-->deeplab
...
### 4_49_no_aug       @ build_data/640-->deeplab
...
### 32_49_no_aug       @ build_data/640-->deeplab
...
### validation_0_20       @ build_data/640-->deeplab
...
### YUN00001_0_239       @ build_data/640-->deeplab
...
### YUN00001_3600       @ build_data/640-->deeplab
...
### YUN00001_0_8999       @ build_data/640-->deeplab
...
### 20160122_YUN00002_700_2500       @ build_data/640-->deeplab
...
### 20160122_YUN00020_2000_3800       @ build_data/640-->deeplab
...
### 20161203_Deployment_1_YUN00001_900_2700       @ build_data/640-->deeplab
...
### 20161203_Deployment_1_YUN00002_1800       @ build_data/640-->deeplab
...
#### stitching       @ validation/50/640-->deeplab
...
#### vis       @ validation/50/640-->deeplab

python3 ../visDataset.py --images_path=/data/617/images/training_32_49_640_640_64_256_rot_15_345_4_flip/images --labels_path=/data/617/images/training_32_49_640_640_64_256_rot_15_345_4_flip/labels --seg_path=log/training_0_31_49_640_640_64_256_rot_15_345_4_flip/xception_0_49/vis/training_32_49_640_640_64_256_rot_15_345_4_flip/raw --save_path=/data/617/images/training_32_49_640_640_64_256_rot_15_345_4_flip/vis_xception_0_49 --n_classes=3 --start_id=0 --end_id=-1

<a id="zip___validation_50_64_0_"></a>
#### zip       @ validation/50/640-->deeplab
...
#### stitching       @ video/50/640-->deeplab
...
#### stitched       @ no_aug_4_49/4/640-->deeplab
...
#### stitched       @ no_aug/16/640-->deeplab
...
#### stitched       @ no_aug/16_rt/640-->deeplab
...
#### stitched       @ no_aug/16_rt_3/640-->deeplab
...
#### stitched       @ no_aug/24/640-->deeplab
...
### vis_png       @ 32_orig/640-->deeplab

<a id="20160122_yun00002_700_2500___vis_png_32_orig_64_0_"></a>
#### 20160122_YUN00002_700_2500       @ vis_png/32_orig/640-->deeplab
...
#### 20160122_YUN00020_2000_3800       @ vis_png/32_orig/640-->deeplab
...
#### 20161203_Deployment_1_YUN00001_900_2700       @ vis_png/32_orig/640-->deeplab
...
#### 20161203_Deployment_1_YUN00002_1800       @ vis_png/32_orig/640-->deeplab
...
#### YUN00001_3600       @ vis_png/32_orig/640-->deeplab
...
#### stitched       @ no_aug/32/640-->deeplab
...
## 4__non_aug       @ 640-->deeplab

<a id="sel_2___4_non_aug_64_0_"></a>
### sel_2       @ 4__non_aug/640-->deeplab
...
### sel_100       @ 4__non_aug/640-->deeplab
...
### sel_1000       @ 4__non_aug/640-->deeplab
...
#### rt       @ sel_1000/4__non_aug/640-->deeplab
...
#### rt2       @ sel_1000/4__non_aug/640-->deeplab
...
## build_data       @ 800-->deeplab

<a id="50___build_data_800_"></a>
### 50       @ build_data/800-->deeplab
...
### 18_-_test       @ build_data/800-->deeplab
...
### validation_0_20_800_800_800_800       @ build_data/800-->deeplab
...
### YUN00001_0_239_800_800_800_800       @ build_data/800-->deeplab
...
#### stitching       @ vis/50/800-->deeplab

python3 ../stitchSubPatchDataset.py src_path=/data/617/images/validation/images  patch_seq_path=log/training_0_31_49_640_640_64_256_rot_15_345_4_flip/xception_0_49/vis/training_32_49_640_640_64_256_rot_15_345_4_flip/raw stitched_seq_path=log/training_0_31_49_640_640_64_256_rot_15_345_4_flip/xception_0_49/stitched/training_32_49_640_640_64_256_rot_15_345_4_flip patch_height=640 patch_width=640 start_id=32 end_id=-1  show_img=0 stacked=1 method=1 normalize_patches=1

<a id="validation___50_800_"></a>
### validation       @ 50/800-->deeplab

CUDA_VISIBLE_DEVICES=0 python3 deeplab_vis.py --logtostderr --model_variant="xception_65" --atrous_rates=6 --atrous_rates=12 --atrous_rates=18 --output_stride=16 --decoder_output_stride=4 --vis_crop_size=640 --vis_crop_size=640 --dataset="training_0_31_49_640_640_64_256_rot_15_345_4_flip" --checkpoint_dir=log/training_0_31_49_640_640_64_256_rot_15_345_4_flip/xception_0_49 --vis_logdir=log/training_0_31_49_640_640_64_256_rot_15_345_4_flip/xception_0_49/vis/validation_0_20_640_640_640_640 --dataset_dir=/data/617/images/training_0_31_49_640_640_64_256_rot_15_345_4_flip/tfrecord --vis_split=validation_0_20_640_640_640_640 --vis_batch_size=50 --also_save_vis_predictions=0 --max_number_of_iterations=1 --eval_interval_secs=0

<a id="stitching___validation_50_80_0_"></a>
#### stitching       @ validation/50/800-->deeplab
