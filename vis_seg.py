...
def run(params):
    ...
    if params.vis and params.save_vis:
    ...
    for img_id in range(params.start_id, params.end_id + 1):
        ...
        if params.vis or params.show_img:
        ...
        if not params.no_labels:
            ...
            if params.vis:
                ...
                if params.add_border:
                    vis_imgs.append(border_img)
                vis_imgs.append(labels_img_vis)
        ...
        if params.vis and params.stitch_seg:
            if params.blended:
            ...
            if params.add_border:
                vis_imgs.append(border_img)
            vis_imgs.append(seg_img_vis)

        if not params.vis and params.show_img:
        ...
        if params.vis:
            ...
            if params.save_vis:
                ...
                cv2.imwrite(seg_save_path, vis_imgs)
